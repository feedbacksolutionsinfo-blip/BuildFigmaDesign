...
function Text6() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start leading-[0] not-italic relative shrink-0 w-full" data-name="Text">
      ...
      <div className="flex flex-col font-['Inter:Medium','Noto_Sans:Regular','Noto_Sans_Math:Regular','Noto_Sans_Symbols:Regular','Noto_Sans_Symbols2:Regular',sans-serif] font-medium justify-center relative shrink-0 text-[18px] text-[rgba(0,0,0,0.55)] tracking-[-0.09px] w-full whitespace-pre-wrap">
        <p className="font-['Inter:Semi_Bold','Noto_Sans:Regular','Noto_Sans_Math:Regular','Noto_Sans_Symbols:Regular','Noto_Sans_Symbols2:Regular',sans-serif] font-semibold leading-[1.45] mb-0 text-black">{`Nem chatbot. Nem egy újabb AI ügyfélszolgálat. Intelligens munkatárs, aki 24/7 dolgozik. `}</p>
        <p className="leading-[1.45] mb-0">​</p>
        <p className="font-['Inter:Regular','Noto_Sans:Regular','Noto_Sans_Math:Regular','Noto_Sans_Symbols:Regular','Noto_Sans_Symbols2:Regular',sans-serif] font-normal leading-[1.5]">{`Az eaisyDesk egy AI-támogatott, omnichannel ügyfélkommunikációs rendszer, amelyben minden csatornán egy AI asszisztens válaszol az ügyfeleknek. Időpontot foglal, értesítést küld, válaszol hívásokra, social media üzenetekre - és ha kell, azonnal eszkalál élő kollégának. Sőt, kimenő kommunikációt és kampányokat is indít. `}</p>
      </div>
    </div>
  );
}
...
export default function Mobile() {
  return (
    <div className="bg-[#f6f6f6] content-stretch flex flex-col items-center relative size-full" data-breakpoint="true" data-breakpoint-id="node-1_159" data-height="9584" data-name="Mobile" data-width="375">
      <Header1 />
      <Hero />
      <Component />
      <Component1 />
